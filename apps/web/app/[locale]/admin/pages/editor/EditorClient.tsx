...
import { Save, Eye, ArrowLeft, Globe, Tag, Image as ImageIcon, Type, LayoutGrid, Code, AlignLeft, FileText, Settings, X, Upload } from 'lucide-react';
...
export default function PageEditor({ initialData }: { initialData?: any }) {
    ...
    const blockTypeIcons: Record<string, any> = { text: AlignLeft, heading: Type, image: ImageIcon, stats: LayoutGrid, cta: FileText };

    const handleSave = async () => {
        setIsSubmitting(true);
        const res = await saveBlogPostAction(pageData, blocks);
        ...
        <div className="p-6 md:p-8 max-w-5xl">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button onClick={handleSave} disabled={isSubmitting} className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold transition-opacity disabled:opacity-50" style={{ background: 'var(--color-brand-600)', color: 'white' }}>
