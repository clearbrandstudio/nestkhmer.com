                        ...
                        {mode === 'main' && (
                            <motion.div key="main" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}>
                                ...
                                <div className="space-y-3 mb-6">
                                    <button onClick={() => { setMode('telegram'); setError(''); }} className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-lg font-bold transition-all hover:scale-[1.02] shadow-lg active:scale-95" style={{ background: '#0088CC', color: 'white', border: '1px solid #00adef' }}>
                                        <MessageCircle className="w-6 h-6" fill="currentColor" />
                                        Register with Telegram (Free)
                                    </button>
