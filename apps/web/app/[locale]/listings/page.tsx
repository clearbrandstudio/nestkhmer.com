...
// Enhanced Mock Data
const allListings = [
    { id: '1', image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&h=500&fit=crop', title: 'Modern Studio with Mekong View', district: 'BKK1, Phnom Penh', price: 650, bedrooms: 1, bathrooms: 1, size: 45, floor: 12, daysOld: 1, agentScore: 92, lat: 11.5564, lng: 104.9282 },
    { id: '2', image: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&h=500&fit=crop', title: 'Spacious 2-Bed in Toul Kork', district: 'Toul Kork, Phnom Penh', price: 850, bedrooms: 2, bathrooms: 2, size: 78, floor: 5, daysOld: 3, agentScore: 87, lat: 11.5721, lng: 104.9012 },
    { id: '3', image: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=500&fit=crop', title: 'Luxury Penthouse on Diamond Island', district: 'Koh Pich, Phnom Penh', price: 2200, bedrooms: 3, bathrooms: 2, size: 145, floor: 28, daysOld: 0, agentScore: 95, lat: 11.5478, lng: 104.9385 },
    { id: '4', image: 'https://images.unsplash.com/photo-1560185893-a55cbc8c57e8?w=800&h=500&fit=crop', title: 'Cozy Flat near Russian Market', district: 'Toul Tom Poung, Phnom Penh', price: 450, bedrooms: 1, bathrooms: 1, size: 38, floor: 3, daysOld: 8, agentScore: 78, lat: 11.5329, lng: 104.9123 },
    { id: '5', image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=500&fit=crop', title: 'Family Villa with Garden', district: 'Sen Sok, Phnom Penh', price: 1500, bedrooms: 4, bathrooms: 3, size: 220, floor: 1, daysOld: 5, agentScore: 91, lat: 11.5834, lng: 104.8821 },
    { id: '6', image: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&h=500&fit=crop', title: 'Riverside Apartment with Pool', district: 'Daun Penh, Phnom Penh', price: 1100, bedrooms: 2, bathrooms: 2, size: 95, floor: 8, daysOld: 12, agentScore: 84, lat: 11.5698, lng: 104.9312 },
    { id: '7', image: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800&h=500&fit=crop', title: 'Garden View Studio', district: 'BKK2, Phnom Penh', price: 380, bedrooms: 0, bathrooms: 1, size: 32, floor: 2, daysOld: 2, agentScore: 80, lat: 11.5512, lng: 104.9213 },
    { id: '8', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&h=500&fit=crop', title: 'Executive Suite near AEON', district: 'Sen Sok, Phnom Penh', price: 950, bedrooms: 2, bathrooms: 2, size: 85, floor: 15, daysOld: 4, agentScore: 89, lat: 11.5789, lng: 104.8899 },
    { id: '9', image: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800&h=500&fit=crop', title: 'Charming Townhouse', district: 'Toul Kork, Phnom Penh', price: 1200, bedrooms: 3, bathrooms: 2, size: 140, floor: 1, daysOld: 6, agentScore: 86, lat: 11.5711, lng: 104.8988 },
];
